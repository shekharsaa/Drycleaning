                        ...
                        <nav>
                            <section class="options">
                                ...
                                <ul class="menu">
                                    ...
                                    <li class="item"><a href="viewmsg"><img src="../images\massege.png" alt="Massege"/> View Massege</a></li>
                                 ...
                                 if($result->num_rows >0){
                                    while($row = $result->fetch_assoc()){ ?>
                                        <tr>
                                             ...
                                             <td><a href="delete/deletemsg.php?msgdel=<?php echo $row['id'];?>">Delete</a></td>       
                                        </tr>
                                <?php }
